...
const QUEUE_EQUATION_LIST_API_URL = '/api/queue-equation-list';
const QUEUE_EQUATION_LIST_API_METHOD = 'post';
const perPage = 100;
              ...
              <table className="table user-data table-hover">
                ...
                <tbody>
                {
                  this.state.userData.map((item, index) => (
                    <UserDataRow key={index} image={item} queueImage={this.queueImage} />
                  ))
                }
                </tbody>
